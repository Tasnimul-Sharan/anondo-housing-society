  ...
  return (
    <section className="py-20 bg-white">
      <div className="text-center mb-16 px-4">
        ...
        <div className="w-20 h-[3px] bg-primary mx-auto mt-3" />
      </div>
        ...
        <div className="relative flex flex-col md:flex-row md:justify-between md:items-start gap-12 md:gap-6">
          {steps.map((step, index) => (
            ...
            >
              ...
              {index !== 0 && (
                <div className="hidden md:block absolute -left-1/2 top-10 w-full h-[2px] bg-[#0E9ED0]" />
              )}
              ...
              <p className="text-gray-600 leading-relaxed text-base text-center max-w-xs">
                {step.desc}
              </p>
            </div>
          ))}
