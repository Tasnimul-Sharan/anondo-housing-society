...
const policySections = [
  ...
  },
  {
    ...
    text: "আপনার তথ্য ব্যবহার করা হয় যোগাযোগ করা, সেবা প্রদান, বুকিং বা আবেদন প্রক্রিয়া সম্পন্ন করা, নোটিশ ও আপডেট জানানো এবং আমাদের ওয়েবসাইট ও গ্রাহকসেবা উন্নত করার জন্য।",
  },
  {
    icon: <FaLock />,
    title: "তথ্যের নিরাপত্তা",
    text: "আমরা ব্যক্তিগত তথ্য সুরক্ষিত রাখতে যুক্তিসঙ্গত প্রশাসনিক, কারিগরি এবং নিরাপত্তামূলক ব্যবস্থা গ্রহণ করি। অনুমতি ছাড়া আপনার ব্যক্তিগত তথ্য প্রকাশ না করার বিষয়ে আমরা সতর্ক থাকি।",
  },
  {
    icon: <FaCookieBite />,
