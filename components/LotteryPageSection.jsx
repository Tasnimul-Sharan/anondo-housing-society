  ...
  return (
    <section className="bg-orange-50 py-16">
      <div className="max-w-5xl mx-auto px-6">
        ...
        {/* Procedure */}
        <Card icon={<FaClipboardList />} title="লটারী অনুষ্ঠানের পদ্ধতি">
          <List
            items={[
              "লে-আউট প্ল্যান প্রণয়নের সুবিধার্থে ২য় পর্যায়ের সমস্ত জমি প্লটের আয়তন অনুযায়ী বিভিন্ন জোনে ভাগ করা হয়েছে।",
              "৫ কাঠার সেক্টরে প্রয়োজনে ৪ ও ৩ কাঠার প্লট অন্তর্ভুক্ত থাকতে পারে।",
              "নীতিমালা অনুযায়ী একাধিক প্লটধারী বা বন্ধু/আত্মীয়রা আবেদন সাপেক্ষে প্লট একত্রে নিতে পারবেন। নির্ধারিত সময়ের পর আবেদন গ্রহণযোগ্য নয়।",
            ]}
          />
        </Card>
        ...
        {/* Rules */}
        <Card icon={<FaGavel />} title="লটারী অনুষ্ঠানের নিয়মাবলি">
          <List
            items={[
              ...
              "একাধিক প্লট বরাদ্দ হলে নির্ধারিত নীতিমালা অনুযায়ী পাশ্ববর্তী প্লট নির্ধারিত হবে।",
              "যথাযথ বরাদ্দ সম্ভব না হলে পুনরায় লটারী অনুষ্ঠিত হবে।",
              ...
              "ভিন্ন আয়তনের প্লট একত্রে বরাদ্দযোগ্য নয়।",
              "লটারীর সময় বড় লে-আউট প্ল্যানে তাৎক্ষণিক ফলাফল রেকর্ড করা হবে এবং লিখিত কপি প্রদান করা হবে।",
            ]}
          />
        </Card>
        ...
        {/* Lottery Order */}
        <Card icon={<FaLayerGroup />} title="লটারী ক্রম">
          <div className="grid md:grid-cols-3 gap-6 mt-4">
            {["১ম গ্রুপ", "২য় গ্রুপ", "৩য় গ্রুপ"].map((g, i) => (
              <div
                key={i}
                className="rounded-2xl border border-orange-200 bg-white p-5 hover:shadow-md transition"
              >
                <h3 className="font-semibold text-slate-800 mb-2">{g}</h3>
                <p className="text-sm text-slate-600">
                  সর্বোচ্চ সংখ্যক প্লট মালিকদের জন্য পৃথক ক্রমিক অনুযায়ী লটারী
                </p>
              </div>
            ))}
          </div>
          ...
          <p className="mt-6 text-sm text-slate-600">
            একইভাবে ৪ কাঠা ও ৩ কাঠার জন্য প্রয়োজন অনুসারে একাধিক গ্রুপ তৈরি করে
            লটারী অনুষ্ঠিত হবে।
          </p>
        </Card>
        ...
        {/* Event */}
        <Card icon={<FaUsers />} title="লটারী অনুষ্ঠান পরিচালনা">
          <div className="bg-slate-100 rounded-xl p-5 mb-5 text-sm">
            <p>
              📦 <b>১ম পাত্র:</b> মালিকদের সিরিয়াল নম্বর
            </p>
            <p>
              📦 <b>২য় পাত্র:</b> প্লটের ক্রমিক নম্বর
            </p>
          </div>

          <List
            items={[
              "প্রথমে ১ম পাত্র থেকে একজন মালিকের সিরিয়াল তোলা হবে।",
              "এরপর ২য় পাত্র থেকে প্লট নম্বর উঠবে এবং সেটিই বরাদ্দ প্লট হবে।",
              "একাধিক প্লটের ক্ষেত্রে নির্ধারিত নিয়ম অনুযায়ী পাশ্ববর্তী প্লট বরাদ্দ হবে।",
            ]}
          />
        </Card>
        ...
        {/* Footer Note */}
        <div className="flex items-center gap-3 bg-orange-100 border border-orange-200 rounded-xl p-5 text-base text-primary">
